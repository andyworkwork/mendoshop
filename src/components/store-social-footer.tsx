...
import { getShopSocialLinks } from '@/lib/social-links'
...
export function StoreSocialFooter({ shop, isLight }: Props) {
  const links = getShopSocialLinks(shop)
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        {links.map((link) => (
          ...
          >
            ...
            {link.id === 'tiktok' && <TikTokIcon />}
            {link.id === 'whatsapp' && <WhatsAppIcon />}
            {link.id === 'website' && <WebsiteIcon />}
          </a>
        ))}
      </div>
    </footer>
