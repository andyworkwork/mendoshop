...
export default async function ConectarMetaPage({ searchParams }: Props) {
  ...
  if (!pending) {
    return (
      <div className="space-y-6">
        <AdminPageHeader description="Elegí qué Página de Facebook conectar con Mendoshop." />
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader description="Elegí la Página de Facebook (y su Instagram vinculado) para publicar desde Mendoshop." />
      {'error' in result ? (
        <>
